			...
			<div class="container row text-right">
				<div class="inner">
					<div class="col-md-4 col-md-offset-8 col-sm-8 col-sm-offset-4">
						<h4>
							<a href="find"> <span class="glyphicon glyphicon-search">
									고수검색</span>
							</a>
						</h4>
							...
							<div class="row topmargin">
								...
								<div class="col-sm-4 img">
									<c:if test="${list.pro_img != null}" var="result">
										<img
											src="${pageContext.request.contextPath}/res/pro_img/${list.pro_img}"
											alt="profile">
									</c:if>
									<c:if test="${list.pro_img == null}" var="result">
										<img
											src="${pageContext.request.contextPath}/res/img/profile.jpg"
											alt="profile">
									</c:if>
	...
	<div class="row">
		<div class="introimg">
			<div class="col-sm-12" style="margin-bottom: 50px; margin-top: 50px;">
				<img src="${pageContext.request.contextPath}/res/img/home_img1.png"
					style="max-width: 100%; height: auto;">
			</div>
		</div>
		<div class="infoimg">
			<div class="col-sm-12" style="margin-bottom: 50px; margin-top: 50px;">
				<img src="${pageContext.request.contextPath}/res/img/home_img2.png"
					style="max-width: 100%; height: auto;">
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="signupnow">
				...
				<a href="register_gosu"><button class="btn btn-primary btn-lg">고수로
						가입하기</button></a>
			</div>
		</div>
	</div>
